...
import com.example.loans.dtoProperties.LoansContactInfoDto;
...
public class LoansController {
    ...
    public String sayHello() {
        return "Hello World! from Loads Service";
    }
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("ugarciac-correlation-id") String correlationId,
